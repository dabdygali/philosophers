...
/*   Updated: 2023/11/23 15:31:30 by dabdygal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Test if string is a number and valid parameter for ft_atoi().
 * @details Function checks whether a string \p str is a number(digits)
